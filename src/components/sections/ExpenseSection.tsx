...
const ExpenseSection: React.FC = () => {
  ...
  const handlePayUPI = () => {
    ...
    toast({
      title: 'Opening UPI Payment 💳',
      description: `Initiating payment of ₹${youOwe.toLocaleString()} via UPI. If UPI app didn't open, please use your UPI app manually.`,
    });
  };
  ...
  const handleSendReminders = () => {
    toast({
      ...
      description: 'Payment reminders have been sent to all pending members.',
    });
  };
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="travel-card p-8">
              ...
              <div className="flex gap-4 mt-8">
                ...
                <Button onClick={handleSendReminders} variant="outline" className="flex-1 h-14 rounded-2xl text-lg font-semibold border-2 border-primary text-primary">
